      ...
      <div className="panel-strong max-w-5xl w-full mx-4 animate-scale-in overflow-hidden flex">
        ...
        <div className="w-1/3 bg-gradient-to-b from-white/5 via-accent-primary/20 to-accent-primary/30 p-8 flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="text-sm font-medium text-text-primary mb-2">
              Ready for a more <span 
                className="px-2 py-0.5 rounded font-semibold"
                style={{
                  backgroundColor: 'var(--theme-color-30, rgba(34, 197, 94, 0.3))',
                  color: 'var(--theme-color)'
                }}
              >productive</span> Monday?
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 p-8 bg-glass-medium relative">
          ...
          <h2 id="onboarding-title" className="text-2xl font-semibold text-text-primary mb-6">
            Welcome to <span style={{ color: 'var(--theme-color)' }}>CalmCove</span>!
          </h2>
          ...
          <div className="space-y-4 mb-8 text-sm text-text-secondary">
            <div className="flex items-center gap-3">
              <div 
                ...
                style={{ backgroundColor: 'var(--theme-color-20, rgba(34, 197, 94, 0.2))' }}
              >
                <svg className="w-4 h-4" style={{ color: 'var(--theme-color)' }} fill="currentColor" viewBox="0 0 24 24">
                  <path d="M8 5v14l11-7z"/>
                </svg>
              </div>
              <p>Press <span className="font-medium" style={{ color: 'var(--theme-color)' }}>[Play]</span> from the control bar on the bottom and enjoy LoFi beats for Focus</p>
            </div>
            <div className="flex items-center gap-3">
              <div 
                className="w-6 h-6 rounded-lg flex items-center justify-center flex-shrink-0"
                style={{ backgroundColor: 'var(--theme-color-20, rgba(34, 197, 94, 0.2))' }}
              >
                <svg className="w-4 h-4" style={{ color: 'var(--theme-color)' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p>Press <span className="font-medium" style={{ color: 'var(--theme-color)' }}>[Mixer]</span> to change genre and add in ambient sounds</p>
            </div>
          </div>
          ...
          <div className="flex gap-3 mb-6">
            <button 
              className="w-12 h-12 rounded-full bg-glass-soft border flex items-center justify-center hover:bg-glass-medium transition-colors"
              style={{ borderColor: 'var(--theme-color-border, rgba(34, 197, 94, 0.3))' }}
            >
